# for block manner
python3 block_generate.py --model_name meta-llama/Llama-3.2-1B-Instruct --input_file cache/2wiki_eval/dataset --output_file cache/benchmark/block_2wiki_instruct
...
python3 block_generate.py --model_name meta-llama/Llama-3.2-1B --input_file cache/2wiki_eval/dataset --output_file cache/benchmark/block_2wiki_base
...
for step in $steps; do
	...
	echo Running checkpoint-$step...;
	python3 block_generate.py --model_name ./model/checkpoint-$step --input_file cache/2wiki_eval/dataset --output_file cache/benchmark/block_2wiki_checkpoint-$step
...
python3 full_generate.py --model_name meta-llama/Llama-3.2-1B-Instruct --input_file cache/2wiki_eval/dataset --output_file cache/benchmark/full_2wiki_instruct
...
python3 full_generate.py --model_name meta-llama/Llama-3.2-1B --input_file cache/2wiki_eval/dataset --output_file cache/benchmark/full_2wiki_base
