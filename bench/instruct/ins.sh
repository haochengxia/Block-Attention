# instruct_models="deepseek-ai/DeepSeek-R1-Distill-Llama-8B"
instruct_models="meta-llama/Llama-3.1-8B-Instruct"
# instruct_models="meta-llama/Meta-Llama-3-8B-Instruct"
# instruct_models="meta-llama/Llama-3.2-3B-Instruct"
